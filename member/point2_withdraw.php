...
?>
  ...
  <div class="form-group">
    <label for="x1" class="col-sm-2 control-label">您的KK余额</label>
    <div class="col-sm-10">
      <input disabled="disabled" class="form-control form-long-w1" id="x1" placeholder="您的KK余额" value="<?php echo $rs['h_point2'];?>">
    </div>
  </div> 
