...
<div class="page-header long-header">
  <h3>账户管理 <small> 直推会员</small></h3>
</div>
<div>
<ol class="breadcrumb">
  <li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <a href="/member/">主页</a></li>
  <li><a href="#">账户管理</a></li>
  <li class="active">直推会员列表</li>
</ol>
</div>
<? if($open){ ?>
<button type="button" class="btn btn-primary btn-block" style="width:150px" onclick="javascript:window.location.href='auto_caimi.php?get=1'">一键采蜜</button>
<? }else{ ?>
<button type="button" class="btn btn-primary btn-block" style="width:150px" onclick="javascript:window.location.href='auto_caimi.php'">订购一键采蜜</button>
<? } ?>
<div class="panel panel-default">
  <div class="panel-heading">直推会员列表</div>
		...
		{	
			...
			if($caimi==2){
				echo '  <tr>
						...
						<td>完成采蜜</td>
						<td>' , $caiminum , '</td>
						<td><a href="/member/myf_fram.php?username='.$val['h_userName'].'" >进入庄园</a></td>
					</tr>';
			}else{
				echo '  <tr>
						<td>' , $val['h_userName'] , '</td>
