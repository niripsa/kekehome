...
<div class="page-header long-header">
  <h3>庄园说明 <small> 操作指导</small></h3>
</div>
<div>
<ol class="breadcrumb">
  <li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <a href="/member/">主页</a></li>
  <li><a href="#">庄园管理</a></li>
  <li class="active">操作指导</li>
</ol>
</div>


<div class="panel panel-default">
  <div class="panel-heading">庄园说明</div>

<div class="panel-body">
<br />
<img src="/imsges/sm.jpg" />
<img src="/imsges/smB.jpg" />
<img src="/imsges/smc.jpg" />
  <div>
    ...
    <span style="font-weight:bold; font-size:14px; float:left; line-height:25px;width:700px;">6、刷新工具：刷新游戏界面，检测是否有新的化肥包产生；</span>
    <br/>
    <span style="font-weight:bold; font-size:14px; float:left; line-height:25px;width:700px;">7、花仙子：每推荐10个会员系统会奖励1个花仙子，上限是4个花仙子。</span>
