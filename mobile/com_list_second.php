...
function list_(){
	...
	{	
		...
		{	
			...
			if($caimi==2){
				echo '
				<div class="friends-body" data-url="/mobile/myf_fram_second.php?level=2&username='.$val['h_userName'].'"><div class="friends-body-head"><span class="friends-body-head-date">' , $val['h_userName'] , '('.$val['h_fullName'].')</span><img src="/mod/images/common_select.png" class="friends-body-head-select"><span class="friends-body-head-right">(完成采蜜)进入果园</span></div></div>
				';
			}else{

				/*	<td>' , ($caimi?'<span  color="red" id = '.$val['h_userName'].' class="caimi">一键采蜜</span>':'等待对方施肥') , '</td>*/
				echo '
				<div class="friends-body" data-url="/mobile/myf_fram_second.php?level=2&username='.$val['h_userName'].'"><div class="friends-body-head"><span class="friends-body-head-date">' , $val['h_userName'] , '('.$val['h_fullName'].')</span><img src="/mod/images/common_select.png" class="friends-body-head-select"><span class="friends-body-head-right">(' , ($caimi?'可以采蜜':'等待对方施肥') , ')进入果园</span></div></div>
				';
			}
...
?>
<div id="dd" class="float-icon"><a href="/mobile/auto_caimi_second.php" onclick="javascript:void(0);"><img src="/mobile/images/zhHoney.png" class="float-icon-img"></a></div>
