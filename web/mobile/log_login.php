...
<div class="page-header long-header">
  <h3><?php echo $webInfo['h_webName']; ?> <small> 查看登录日志</small></h3>
</div>
<div>
<ol class="breadcrumb">
  <li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <a href="/member/">主页</a></li>
  <li><a href="#"><?php echo $webInfo['h_webName']; ?></a></li>
  <li class="active">查看登录日志</li>
</ol>
</div>


<div class="panel panel-default">
  <div class="panel-heading">查看登录日志</div>
...
function list_(){
	...
	$mid = 111;
	$total_count = $db->counter('h_log_login_member', "h_userName = '{$memberLogged_userName}'", 'id');
	$page = (int)$page;
	...
	$query = "select * from `h_log_login_member` where h_userName = '{$memberLogged_userName}' order by h_addTime desc,id desc LIMIT $from_record, $list_num";
