...
$pageTitle = '('.$memberLogged_userName.')';
require_once 't.php';
?>
...
<div class="bg" style="background:url(/images/farm.png) top left no-repeat;background-size: contain;">
	...
	<?php } ?>
	<?php if($bogy>=3){  ?>
	   <div id="daocaoren3" style="top:590px;"><img src="imsges/dog.png" border="0" /></div>
	<?php } ?>
	<?php if($bogy>=4){  ?>
	   <div id="daocaoren4" style="top:690px; left:500px;"><img src="imsges/dog.png" border="0" /></div>
	<?php } ?>
