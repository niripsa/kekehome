CKEDITOR.dialog.add('flvPlayer',function(editor){
	...
	resizable:CKEDITOR.DIALOG_RESIZE_BOTH,
		...
		onOk:　function(){
			...
			iHtml += '<param name="movie" value="/ckeditor/plugins/flvPlayer/jwplayer.swf">';
			...
			iHtml += '<embed src="/ckeditor/plugins/flvPlayer/jwplayer.swf?file='+html+'" autostart="'+ autostart +'" allowFullScreen="true" menu="false" quality="high" width="'+ vWidth +'" height="'+ vHeight +'" type="application/x-shockwave-flash"></embed>';
			iHtml += '</object>';
