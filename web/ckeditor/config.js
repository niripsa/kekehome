...
CKEDITOR.editorConfig = function( config ) {
	...
	var webCode = "php";
	config.filebrowserUploadUrl = '/ckeditor/upload/' + webCode + '/uploadSave.' + webCode + '?ut=file';
	config.filebrowserImageUploadUrl = '/ckeditor/upload/' + webCode + '/uploadSave.' + webCode + '?ut=image';
	config.filebrowserFlashUploadUrl = '/ckeditor/upload/' + webCode + '/uploadSave.' + webCode + '?ut=flash';
	...
	[
		...
		['Image','Flash','flvPlayer','Table','Iframe','Smiley','HorizontalRule'],
		['Source','-','Maximize']
	];
