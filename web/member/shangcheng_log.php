...
<div class="page-header long-header">
  <h3>财务管理 <small> 商城转账记录</small></h3>
</div>
<div>
<ol class="breadcrumb">
  <li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <a href="/member/">主页</a></li>
  <li><a href="#">财务管理</a></li>
  <li class="active">商城转账记录</li>
</ol>
</div>


<div class="panel panel-default">
  <div class="panel-heading">商城转账记录</div>
...
function list_(){
	...
	$mid = 111;
	$total_count = $db->counter('h_log_point2', "h_userName = '{$memberLogged_userName}' and h_type_id = 10  ", 'id');
	$page = (int)$page;
	...
	$query = "select * from `h_log_point2` where h_userName = '{$memberLogged_userName}' and h_type_id = 10 order by h_addTime desc,id desc LIMIT $from_record, $list_num";
