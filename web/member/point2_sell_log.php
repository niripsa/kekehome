...
<div class="page-header long-header">
  <h3>交易系统 <small> KK卖出记录</small></h3>
</div>
<div>
<ol class="breadcrumb">
  <li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <a href="/member/">主页</a></li>
  <li><a href="#">交易系统</a></li>
  <li class="active">KK卖出记录</li>
</ol>
</div>


<div class="panel panel-default">
  <div class="panel-heading">KK卖出列表</div>
...
<!--MAN End-->
 ...
 <script>
	...
	function jihuo_queren2(c){
		tishi2();
		$.get("/member/bin.php?act=point2_sell_confirm&id="+encodeURI(c)+"&num=<?php echo $sxf ?>",function(e){
			tishi2close();
			if(e!=""){
				if(unescape(e)=='修改成功'){
