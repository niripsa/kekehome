...
?>
	...
	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	直推奖: <strong><?php
    $rs = $db->get_one("select sum(h_price) as sumP from `h_log_point1` where h_userName = '{$memberLogged_userName}' and (h_type_id = 2 or h_type_id = 3)");
	if(strlen($rs['sumP']) <= 0){
		$rs['sumP'] = 0;
	}
	echo $rs['sumP'];
