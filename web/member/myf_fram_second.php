...
<div class="bg">
  ...
  <div class="info">&nbsp;&nbsp;<span id="unumber">用户：<?=$myfuserName?></span>&nbsp;&nbsp;&nbsp;&nbsp;总量：<span class="red" id="zong"><?php echo ($rs['h_point2']+$farm_money);?></span>&nbsp;&nbsp;仓库：<span class="red" id="stock"><?php echo $rs['h_point2'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;播种：<span class="red" id="zmei"><?php echo $farm_money?></span>&nbsp;&nbsp;肥料：<span class="red" id="fei"><?php echo $money_now;?></span>&nbsp;&nbsp;蜂蜜：<span class="red" id="fei"><?php echo $fengmi;?></span>&nbsp;&nbsp;丘比特：<span class="red" id="dog"><?php echo $dog;?></span>&nbsp;&nbsp;花仙子：<span class="red" id="bogy"><?php echo $bogy;?></span>&nbsp;&nbsp;总生长：<span class="red" id="growth_total"><?php echo $growth_total;?></span></div>
  ...
  <div class="tooldiv"> 
	    ...
	    <?php  
			...
			/*会否已采蜜*/
			$query = "select * from  `h_usebee`  where  h_fusername = '{$myfuserName}'  and  h_level = 2 and DATE_FORMAT(FROM_UNIXTIME(unix_timestamp(h_addTime)),'%Y-%m-%d') = '".$days."'";
