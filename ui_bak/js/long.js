...
function play(y){
	...
	if(y=='0x10'){tishi4('验证码错误','#x7');sxyzm();}
	...
	if(y=='0x21'){tishi4('账户不存在','#x1');sxyzm();}
	if(y=='0x22'){tishi4('密码错误','#x2');sxyzm();}
	if(y=='0x23'){tishi4('验证码错误','#x3');sxyzm();}
	if(y=='0x24'){tishi3('账户被限制登录');sxyzm();}
	if(y=='0x25'){tishi3('账户未激活,请先联系您的推荐人激活');sxyzm();}
	if(y=='0x29'){window.location.href="index.php";}
	...
	if(y=='0x79'){window.location.href="/member/";}	
	
	if(y=='0x98'){tishi3("参数错误");}
	if(y=='0x99'){tishi3("操作频繁！@！");}
	if(y=='0x100'){tishi3("操作成功");}
	if(y=='0x101'){window.location.href="login.php";}
...
function sxyzm(){
	$("#yzmpic").attr('src',"../include/getCode.php?t="+(new Date().getTime())); 
	}
